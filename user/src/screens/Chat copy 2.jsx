...
export default class Admin extends Component {
  ...
  componentDidMount() {
    ...
    if (isAuth()) {
      ...
      const www = { user: 'res.data._id', email: 'res.data.email', name: 'www', id: 'res.data._id', foto: 'res.data.foto' };
  ...
  render() {
    ...
    const usser = this.state.users.map((user, i) => {
      return (
        <>
          {<div key={i} className="border bg-light p-1 pb-0 rounded" style={{ marginBottom: ".2em" }}>

...
exports.forgotPasswordValidator = [
  check('email').not().isEmpty().isEmail().withMessage('Formato de email no aceptado')
];

exports.resetPasswordValidator = [
  check("newPassword").not().isEmpty().isLength({ min: 3 }).withMessage("El password debe contener 3 caracteres minímo"),
];